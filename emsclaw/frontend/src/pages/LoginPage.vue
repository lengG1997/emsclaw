      ...
      <div class="login-header w-full max-w-[720px] pt-[24px] mb-[32px] max-sm:pt-[0px]">
        <div class="flex flex-col items-center gap-[16px]">
          ...
          <h1 class="text-[20px] font-bold text-center text-[var(--text-primary)] max-sm:text-[18px]">
            ...
            <template v-else-if="isRegistering">{{ t('Register to') }} <span class="brand-text bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-red-500 to-amber-500" style="background-size:200% 100%">emsclaw</span></template>
            <template v-else>{{ t('Login to') }} <span class="brand-text bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-red-500 to-amber-500" style="background-size:200% 100%">emsclaw</span></template>
          </h1>
