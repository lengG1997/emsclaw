...
def configure_permissions(app_name="emsclaw 助手", scope="all"):
    try:
...
def main():
    ...
    cp = sub.add_parser("create_app"); cp.add_argument("--name", default="emsclaw 助手")
    ...
    cp_perm.add_argument("--name", default="emsclaw 助手")
    ...
    try:
        {"open_login": open_login, "check_login": check_login,
         ...
         "configure_permissions": lambda: configure_permissions(getattr(a, "name", "emsclaw 助手"), getattr(a, "scope", "all")),
