...
from emsclaw_backend.im.base import IMAdapter, IMChat, IMMessage, IMMessageFormatter, IMPlatform, IMResponse, IMUser
...
class LarkAdapter(IMAdapter):
    ...
    def _sanitize_card_content(self, card_content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        trimmed = {
            ...
            "header": {
                "title": {"tag": "plain_text", "content": "emsclaw 处理中"},
                "template": "blue",
            },
            "body": {
                "elements": [
    ...
    def _build_fallback_card(self, text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "config": {"update_multi": True},
            "header": {
                "title": {"tag": "plain_text", "content": "emsclaw 任务进展"},
                "template": "blue",
            },
            "body": {
                "elements": [
